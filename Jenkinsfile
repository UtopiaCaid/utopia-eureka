    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh """aws cloudformation deploy --region us-east-2 --stack-name UtopiaEurekaMS 
                --template-file ./test-utopia-cftemplate.yml --parameter-overrides ApplicationName=UtopiaEurekaMS
